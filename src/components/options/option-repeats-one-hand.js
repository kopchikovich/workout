    ...
    return (
        <label className='input__container'>
            ...
            <div className='input__container input__container--column'>
                ...
                <input type='number' className='input__input input__input--repeats' name='repeats-left' />
                <span className='input__text--small'>Правая</span>
                <input type='number' className='input__input input__input--repeats' name='repeats-right' />
            </div>
        </label>
    )
}
