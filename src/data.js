...
const exs = {
    ...
    'run 10x10': new Exercise('Тренировка 10х10', `Разминка:<br> - Медленный бег 10-15 мин<br><br> Тренировка 10х10:<br> - Тренировка высокого старта (старт и ускорение на 10 метров) 5 раз<br> - Медленный бег с правильными резкими разворотами 5м<br> - 4 по 10м полноценные - 3-4 серии<br> - Бег 5-10-15 метров 2 серии<br> - Бег 10м с переносом 3 теннисных шаров (камней)<br> - Финишный старт: 20 секунд бег на месте с высоким пониманием ног, затем рывок на 10 метров (товарищ удерживает на поясе эспандером)<br> - Прыжки на скакалке 20с затем ускорение<br><br>Заминка:<br> - Бёрпи (упор присев -> упор лёжа ->  упор присев -> выпрыгивание (руки вверх) -> повторить) 10-15 раз<br> - Прыжки на скакалке 2-3 минуты<br> - Зашагивание на тумбу (ногу на упор второй «зашагиваю в воздух» - вынос бедра) по 10 раз на ногу<br> - Прыжки на тумбу (пониже прошлой) на одной ноге по 15 раз, затем 15 раз на 2 ноги<br> - Ускорения на участке 60м в среднем темпе`, ['legs'], 1, ['time'])
};
